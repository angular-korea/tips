...
- **빌드 옵티마이저**
  ...
  - Angular CLI는 옵티마이저를 기본 옵션으로 사용하므로 [번들 사이즈가 감소](https://next.angular.io/guide/webpack)됐습니다.
...
- Zone 스피드 개선
  ...
  - Zone 스피드가 개선 됐고 더군다나 성능을 갖춘 애플리케이션을 개발 하기 위해 zones을 사용하지 않게할 수 있습니다.
